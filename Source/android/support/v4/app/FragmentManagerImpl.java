...
import android.support.v4.p002c.C0048b;
...
final class FragmentManagerImpl extends FragmentManager {
    ...
    int mCurState = 0;
    boolean mDestroyed;
    Runnable mExecCommit = new C00321();
    ...
    private void throwException(RuntimeException runtimeException) {
        ...
        PrintWriter printWriter = new PrintWriter(new C0048b(TAG));
    ...
    public final String toString() {
        ...
        if (this.mParent != null) {
            C0047a.m53a(this.mParent, stringBuilder);
        } else {
    ...
    L_0x0027:
        monitor-enter(r6);
        r3 = r6.mPendingActions;	 Catch:{ all -> 0x0099 }
    ...
    L_0x0058:
        ...
        goto L_0x003b;
    L_0x005c:
        r1 = r6.mPendingActions;	 Catch:{ all -> 0x0099 }
        r3 = r1.size();	 Catch:{ all -> 0x0099 }
        r1 = r6.mTmpActions;	 Catch:{ all -> 0x0099 }
    ...
    L_0x006b:
        ...
        r6.mTmpActions = r1;	 Catch:{ all -> 0x0099 }
    L_0x006f:
        r1 = r6.mPendingActions;	 Catch:{ all -> 0x0099 }
        r4 = r6.mTmpActions;	 Catch:{ all -> 0x0099 }
        r1.toArray(r4);	 Catch:{ all -> 0x0099 }
        r1 = r6.mPendingActions;	 Catch:{ all -> 0x0099 }
        r1.clear();	 Catch:{ all -> 0x0099 }
        r1 = r6.mActivity;	 Catch:{ all -> 0x0099 }
        r1 = r1.mHandler;	 Catch:{ all -> 0x0099 }
        r4 = r6.mExecCommit;	 Catch:{ all -> 0x0099 }
                ...
                if (fragmentManagerState.mBackStack != null) {
                    ...
                    for (i2 = 0; i2 < fragmentManagerState.mBackStack.length; i2++) {
                        ...
                        if (DEBUG) {
                            ...
                            instantiate2.dump("  ", new PrintWriter(new C0048b(TAG)), HONEYCOMB);
                        }
